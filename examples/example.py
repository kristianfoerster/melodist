...
# MELODIST using the data for De Bilt. Please download the data from
# https://cdn.knmi.nl/knmi/map/page/klimatologie/gegevens/uurgegevens/uurgeg_260_2001-2010.zip
# or browse the entire catalog for more data:
# https://www.knmi.nl/nederland-nu/klimatologie/uurgegevens
#
# Let's assume the data has been downloaded and unpacked. Then you can load the
...
# optional: select one year (a subselection can be processed much faster)
data_obs_hourly = data_obs_hourly.loc['2009-01-01':'2009-12-31']
...
debilt.statistics = melodist.StationStatistics(data_obs_hourly)
